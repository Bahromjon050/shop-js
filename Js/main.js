    ...
    cards.innerHTML += `
            <div class="card">
                <div class="card_header">
                    ...
                    <div><button onclick="like(${i})" style="background: ${
      btn.like ? "" : "#b8e673"
    }"><img src="./icon/cardlike.svg"/></button></div>
                </div>
                <div class="card_body">
                    <span><img src="${btn.img}" alt=""></span>
                    <h2>${btn.nema}</h2>
                    <p>$${parseInt(
                      btn.narxi - (btn.narxi / 100) * btn.chegirma
                    )} <del>$${btn.narxi}</del></p>
                </div>
...
const modalFun = (i) => {
  ...
  let baza = `
    ...
    <p>narxi: $${
      mevalar[i].count *
      parseInt(
        mevalar[i].narxi - (mevalar[i].narxi / 100) * mevalar[i].chegirma
      )
    }</p>
...
let olma = [
  {
    ...
    haqida:
      "1 Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio optio animi unde laudantium facere ut maxime doloremque, possimus, similique aliquam quisquam delectus dolorum soluta iste rem accusantium maiores! Iure, magni?",
  },
  {
    id: 1,
    img: "./img/cr2.png",
    ...
    haqida:
      "2 Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio optio animi unde laudantium facere ut maxime doloremque, possimus, similique aliquam quisquam delectus dolorum soluta iste rem accusantium maiores! Iure, magni?",
  },
  {
    id: 2,
    img: "./img/milk 1.png",
    name: "Dairy & Eggs",
    haqida:
      "3 Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio optio animi unde laudantium facere ut maxime doloremque, possimus, similique aliquam quisquam delectus dolorum soluta iste rem accusantium maiores! Iure, magni?",
  },
  {
    id: 3,
    img: "./img/cr3.png",
    name: "Beverages",
    haqida:
      "4 Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio optio animi unde laudantium facere ut maxime doloremque, possimus, similique aliquam quisquam delectus dolorum soluta iste rem accusantium maiores! Iure, magni?",
  },
  {
    id: 4,
    img: "./img/cr4.png",
    name: "Snacks",
    haqida:
      "5 Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio optio animi unde laudantium facere ut maxime doloremque, possimus, similique aliquam quisquam delectus dolorum soluta iste rem accusantium maiores! Iure, magni?",
  },
  {
    id: 5,
    img: "./img/cr5.png",
    name: "Home Care",
    haqida:
      "6 Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio optio animi unde laudantium facere ut maxime doloremque, possimus, similique aliquam quisquam delectus dolorum soluta iste rem accusantium maiores! Iure, magni?",
  },
];
  ...
  sabzavot.forEach((btn, i) => {
    cards2.innerHTML += `
            <div class="card">
                <div class="card_header">
                    <div><p>15%Off</p></div>
                    <div><button onclick="like2(${i})" style="background: ${
      btn.like ? "" : "#b8e673"
    }"><img src="./icon/cardlike.svg"/></button></div>
                </div>
                <div class="card_body">
...
const sazavotnarx = (i) => {
  ...
  let sabzavotmodal = `
    ...
    <p>narxa : ${
      sabzavot[i].count *
      parseInt(
        sabzavot[i].narxi - (sabzavot[i].narxi / 100) * sabzavot[i].chegirma
      )
    }$</p>
  ...
  freesh.forEach((btn, i) => {
    cards3.innerHTML += `
            <div class="card">
                <div class="card_header">
                    <div><p>15%Off</p></div>
                    <div><button onclick="like3(${i})" style="background: ${
      btn.like ? "" : "#b8e673"
    }"><img src="./icon/cardlike.svg"/></button></div>
                </div>
                <div class="card_body">
...
const freeshnarx = (i) => {
  ...
  let freeshmodal = `
    ...
    <p>narxa : ${
      freesh[i].count *
      parseInt(freesh[i].narxi - (freesh[i].narxi / 100) * freesh[i].chegirma)
    }$</p>
